...
class Woo_Quick_View {
	...
	public function __construct() {
		if ( defined( 'WOO_QUICK_VIEW_VERSION' ) ) {
			$this->version = WOO_QUICK_VIEW_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woo-quick-view-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woo-quick-view-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-woo-quick-view-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-woo-quick-view-public.php';

		$this->loader = new Woo_Quick_View_Loader();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Woo_Quick_View_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Woo_Quick_View_Public( $this->get_plugin_name(), $this->get_version() );
